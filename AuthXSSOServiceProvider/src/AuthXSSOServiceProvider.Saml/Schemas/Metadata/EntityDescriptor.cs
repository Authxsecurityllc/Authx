...
namespace AuthXSSOServiceProvider.Saml.Schemas.Metadata
{
    ...
    {
        const string elementName = SamlMetadataConstants.Message.EntityDescriptor;
        ...
        public EntityDescriptor(SamlConfiguration config, bool signMetadata = true) : this()
        {
        ...
        protected IEnumerable<XObject> GetXContent()
        {
            ...
            yield return new XAttribute(SamlMetadataConstants.Message.EntityId, EntityId);
        ...
        public virtual EntityDescriptor ReadIdPSsoDescriptor(string idPMetadataXml)
        {
            ...
            var entityDescriptorElement = metadataXmlDocument.DocumentElement.SelectSingleNode($"//*[local-name()='{SamlMetadataConstants.Message.EntityDescriptor}']") as XmlElement;
            if (entityDescriptorElement == null)
            {
                throw new SamlRequestException("EntityDescriptorElement element not found in Metadata.");
            }

            if (entityDescriptorElement.NamespaceURI != SamlMetadataConstants.MetadataNamespace.OriginalString)
            {
                throw new SamlRequestException("Not Metadata.");
            }

            EntityId = entityDescriptorElement.Attributes[SamlMetadataConstants.Message.EntityId].GetValueOrNull<string>();

            Id = entityDescriptorElement.Attributes[SamlMetadataConstants.Message.Id].GetValueOrNull<Saml2Id>();

            var idPSsoDescriptorElement = entityDescriptorElement[SamlMetadataConstants.Message.IdPSsoDescriptor, SamlMetadataConstants.MetadataNamespace.OriginalString];
        ...
        public virtual EntityDescriptor ReadSPSsoDescriptor(string spMetadataXml)
        {
            ...
            var spSsoDescriptorElement = entityDescriptorElement[SamlMetadataConstants.Message.SPSsoDescriptor, SamlMetadataConstants.MetadataNamespace.OriginalString];
