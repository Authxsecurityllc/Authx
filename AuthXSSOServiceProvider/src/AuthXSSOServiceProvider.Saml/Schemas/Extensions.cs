...
namespace AuthXSSOServiceProvider.Saml.Schemas
{
    public class Extensions
    {
        ...
        XElement envelope = new XElement(SamlConstants.ProtocolNamespaceX + elementName);
        ...
        {
            if (!envelope.Name.Namespace.Equals(SamlConstants.ProtocolNamespaceX))
            {
                throw new Exception($"Invalid Extensions namespace. Required namespace '{SamlConstants.ProtocolNamespaceX}'.");
            }
